...
class MedicalCertificatePolicy
{
     ...
     */
    public function restore(User $user, MedicalCertificate $medicalCertificate): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, MedicalCertificate $medicalCertificate): bool
    {
        return false;
    }
}
